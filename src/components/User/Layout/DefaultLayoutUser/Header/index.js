...
function Header() {
          ...
          let res = await registerUser(
            ...
            .then((res) => {
              ...
              Swal.fire({
                ...
                text: "Chào mừng bạn đến với an dương shop!",
  ...
  const blurFullName = () => {
    const fullNameRegex =
      /^[a-zA-Z0-9\s.,!?áàảãạâấầẩẫậăắằẳẵặéèẻẽẹêếềểễệíìỉĩịóòỏõọôốồổỗộơớờởỡợúùủũụưứừửữựýỳỷỹỵđ]+$/;
      ...
      <div className={cx("header")}>
        ...
        <div className="d-flex">
          <div className={cx("header-final")}>
            ...
            {user && user.auth === true ? (
              <a onClick={handleLogout} className={cx("header-final-login")}>
                Logout
              </a>
            ) : (
          ...
          <div className={cx("header-info")}>
            ...
            <div
              className={cx("info-img-container", "header__navbar-item--noti")}
            >
              {user.auth === true && (
                <img
                  src={"http://localhost:3001/" + localStorage.getItem("avt")}
              ...
              <div className={cx("header-noti")}>
                <ul className={cx("header-noti-list")}>
                  <li className={cx("header-noti-item")}>
                    <Link to={"/profile"} className={cx("header-noti-link")}>
                      Tài khoản
                    </Link>
                  </li>
                  <li className={cx("header-noti-item")}>
      ...
      <Modal ref={modalRegister}>
        <div className={cx("modal-body-header")}>
          ...
          <div
            ...
            className={cx("modal-body-header-icon")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="2em"
        ...
        <div className={cx("modal-body-content")}>
          <div
            ...
            className={cx("modal-body-content-item")}
          >
            <input
              ref={usernameRef}
          ...
          {usernameError === true ? (
            ...
            >
              Không chứa kí tự đặc biệt và tối thiểu 3 kí tự
            </p>
          ) : (
            ""
          )}
          <div
            ref={emailRefContainer}
            className={cx("modal-body-content-item")}
          >
            <input
              ref={emailRef}
          ...
          {emailError === true ? (
            ...
            >
              Bạn phải nhập đúng định dạng name@gmail.com
            </p>
          ) : (
            ""
          )}
          ...
          {fullnameError === true ? (
            ...
            >
              Họ tên của bạn không được chứa kí tự đặc biệt
            </p>
          ) : (
            ""
          )}
          <div
            ref={passwordRefContainer}
            className={cx("modal-body-content-item")}
          >
            <input
              value={password}
        ...
        <div className={cx("modal-body-content-footer")}>
          <button onClick={handleRegister} className={cx("btn-primary-m-user")}>
            Đăng Kí
          </button>
        </div>
        {loadingAPI && (
