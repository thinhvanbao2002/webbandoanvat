    ...
    return (
        <div class={cx('wrapper')}>
            ...
            <div class={cx('list-content')}>
                ...
                <div class={cx('list-content-body')}>
                    <table class={cx('list-content-table')}>
                        <tr>
                            <th>STT</th>
                            <th>Mã Đơn Hàng</th>
                            <th>Mã Khách Hàng</th>
                        ...
                        <tr>
                            ...
                            <td>30000000 VND</td>
                            <td>
                                <div class={cx('list-content-operation', 'd-flex')}>
                                    <div class={cx('operation-update')}>
                                        <button class={cx('operation-update-btn')}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="25"
                                    ...
                                    <div class={cx('operation-delete')}>
                                        <button class={cx('operation-delete-btn')}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
                                    ...
                                    <div class={cx('operation-detail')}>
                                        <div class={cx('operation-detail-btn')}>
            ...
            <div class={cx('list-content-modal', 'active')}>
                <div class={cx('modal-container')}>
                    <div>
                        <div class={cx('modal-header')}>
                            <h2 class={cx('modal-header-title')}>Thêm / Sửa Sản Phẩm</h2>
                        </div>
                        <div class={cx('modal-body')}>
                            <div class={cx('modal-body-item')}>
                                <h5 class={cx('modal-body-item-title')}>
                                    Tên Sản Phẩm <span style={{ color: 'red' }}>*</span>
                                </h5>
                                <input class={cx('item-input-text')} type="text" placeholder="Nhập tên sản phẩm" />
                            </div>
                            <div class={cx('modal-body-item')}>
                                <h5 class={cx('modal-body-item-title')}>
                                    Ảnh Sản Phẩm<span style={{ color: 'red' }}>*</span>
                                </h5>
                                <div class="d-flex al-cent ">
                            ...
                            <div class={cx('modal-body-item')}>
                                ...
                                <input class={cx('item-input-text')} type="text" placeholder="Nhập giá tiền" />
                            </div>
                            <div class={cx('modal-body-item')}>
                                <h5 class={cx('modal-body-item-title')}>
                                    Mô Tả<span style={{ color: 'red' }}>*</span>
                                </h5>
                                <input class={cx('item-input-text')} type="text" placeholder="Nhập mô tả" />
                            </div>
                        </div>
                    </div>
