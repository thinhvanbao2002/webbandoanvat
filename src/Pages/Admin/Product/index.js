    ...
    <>
      <div className={cx("wrapper")}>
        <h3 className={cx("manager-title")}>
          <span style={{ color: "#A09A97" }}>Quản lý sản phẩm</span>/
                        ...
                        <div className={cx("list-content-operation", "d-flex")}>
                          ...
                          <div className={cx("operation-detail")}>
                            <div
                              ...
                              className={cx("operation-detail-btn")}
                            >
            ...
            <div className={cx("content-footer-operation")}>
              <div className={cx("show-quantity")}>
                ...
                <div className={cx("select-show-quantity")}>
                  <select
                    className={cx("select-number-of-acc")}
                    name="cars"
                    id="cars"
                  >
          ...
          <div className={cx("modal-container")}>
            <div>
              <div className={cx("modal-header")}>
                <h2 className={cx("modal-header-title")}>
                  Thêm / Sửa Sản Phẩm
                </h2>
              </div>
                ...
                <div className={cx("modal-body-item")}>
                  ...
                  >
                    ...
                    >
                      Tải ảnh
                      <VisuallyHiddenInput
                        onChange={handleChooseListImage}
                        type="file"
                      />
                    </Button>
                    {detailImages &&
            ...
            <div className={cx("modal-footer")}>
              <button
                ...
                className={cx("btn-primary-m", "btn-close-m")}
              >
                Thoát
              </button>
              <button
                onClick={handleAddProduct}
                className={cx("btn-primary-m", "btn-confirm-m")}
              >
                Xác Nhận
              </button>
            </div>
                  ...
                  >
                    ...
                    {imageEncode ? (
                      ...
                      <img
                        alt="Bạn chưa chọn ảnh"
                        style={{ width: "100px", height: "100px" }}
                        src={"http://localhost:3001/imgProduct/" + imageSrc}
                      />
                    )}
                  </div>
                </div>
