                ...
                <div className="detail-product-body">
                    <div className="product-body-image">
                        <div className="body-img-main">
                            <img className="img-main" src="https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-ljuotzdb62o2a9" alt=""/>
                    ...
                    <div className="product-body-infomation">
                        <div>
                            <h3>Dui ga cay sieu ngon tuuyet ca la voi ong mat troi ngon tuuyet ca la voi ong mat troi ngon tuuyet ca la voi ong mat troi ngon tuuyet ca la voi ong mat troi</h3>
                            <div className="quantity-info">
                                <h5>832 <span>đã bán</span></h5>
                                <div>|</div>
                                <h5>426 <span>có sẵn </span></h5>
                            </div>
                            ...
                            <div className="body-info-desc">
                                <h4>Mô tả</h4>
                                <p> An toàn, đảm bảo: Đồ ăn vặt của Bà Tuyết đều có giấy chứng nhận An toàn vệ sinh thực phẩm, Bao bì đóng hộp chắc chắn, đầy đủ ngày sản xuất và hạn sử dụng. Hàng được Ship đi bằng hộp Cát-tông cứng 3 lớp nên bạn yên tâm đồ ăn chắc chắn sẽ luôn còn mới và ngon lành cho đến khi bạn nhận được ^^</p>
                            </div>
                        </div>
                        <div>
